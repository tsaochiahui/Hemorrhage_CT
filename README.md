...
| 4 | task1_train_mac_cpu_add_argmentation.py | task1_resnet18_mac_add_augmentayion.pt;confusion_matrix_task1_add_augmentayion.png;task1_loss_comparison_add_augmentayion.png| Data Augmentation |
</aside>
